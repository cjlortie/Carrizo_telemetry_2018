...
data <- data %>%
  dplyr::select(-notes, -pulseinterval, -'microhabitat 2', -'microhabitat 3')
...
ggplot(micro.changes, aes(rep, n, color = microhabitat1)) +
  geom_point() +
...
ggplot(scales, aes(microhabitat.simple, n, color = mesohabitat)) +
  geom_point() +
  coord_flip() +
  scale_color_brewer(palette = "Set1")


ggplot(na.exclude(pop.data), aes(mesohabitat, n)) +
  geom_boxplot() +
  facet_wrap(~time.class) + 
