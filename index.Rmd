...
#simplify data
s.data <- data %>%
  dplyr::select(lizard, date, time.class, long, lat)
...
proj4string(track.pop) <- CRS("+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0") #assign projection and coordinate reference system
